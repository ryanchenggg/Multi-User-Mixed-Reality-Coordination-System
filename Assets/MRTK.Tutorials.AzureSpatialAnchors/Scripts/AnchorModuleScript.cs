...
public class AnchorModuleScript : MonoBehaviour
{
    ...
    private bool isCloudManagerInitialized = false;
    ...
    {   
        if(!isCloudManagerInitialized)
        {
            ...
            if(cloudManager != null)
            {
                cloudManager.AnchorLocated += CloudManager_AnchorLocated;
                anchorLocateCriteria = new AnchorLocateCriteria();
                isCloudManagerInitialized = true;
                Debug.Log("Cloud Manager Initialized");
            }
        }
        lock (dispatchQueue)
        {
    ...
    public async void CreateAzureAnchor(GameObject theObject)
    {
        ...
        Debug.Log("Local cloud anchor created");
        ...
        Debug.Log("Local cloud anchor position set to local anchor position");
